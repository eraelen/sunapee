...
var userdb = [
{name: 'Tim Berners-Lee' ,username: 'tim', password: 'mit', uid: 1, email: "aqua_manga@yahoo.com", location: "Massachusetts", website: "amazon.com", profilePic: "defaultProfilePic.jpg", follower: ["caleb","hazel"], following: ["caleb","hazel"], tweets: [0,4], profVis: "Public", mentionPerm: "Public", pmPerm: "Public"},
{name: 'Hazel Rozetta', username: 'hazel', password: 'lezah', uid: 2, email: "ysasaki@smith.edu", location: "United States", website: "petco.com", profilePic: "defaultProfilePic.jpg", follower: ["tim","caleb"], following: ["tim", "caleb"], tweets: [1,5], profVis: "Public", mentionPerm: "Public", pmPerm: "Public"},
{name: 'Caleb Marks', username: 'caleb', password: 'belac', uid: 3, email: "ysasaki2014@gmail.com", location: "Asia", website: "ebay.com", profilePic: "defaultProfilePic.jpg", follower: ["hazel","tim"], following: ["hazel","tim"], tweets: [2,3], profVis: "Public", mentionPerm: "Public", pmPerm: "Public"}
];
