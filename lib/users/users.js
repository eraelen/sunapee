...
{name: 'Eeyore', username: 'cheerfuldonkey', password: 'eeyore', uid: 4, email: "mynameiseeyore@hundredacrewood.com", location: "Hundred Acre Wood", website: "", profilePic: "/images/users/cheerfuldonkey/eeyore_profilepic.jpg", follower: [], following: [], tweets: [], profVis: "Public", mentionPerm: "Public", pmPerm: "Public", background: ""},
{name: 'Winnie', username: 'thepooh', password: 'winnie', uid: 5, email: "mynameiswinnie@hundredacrewood.com", location: "Hundred Acre Wood", website: "", profilePic: "/images/users/thepooh/pooh_profilepic.jpg", follower: [], following: [], tweets: [], profVis: "Public", mentionPerm: "Public", pmPerm: "Public", background: ""}
];
...
function searchPeople (query) {
	...
	for (var i=0; i<userdb.length; i++) {
		if ((userdb[i].name.match(reQuery) !== null) || (userdb[i].username.match(reQuery) !== null)) {
			...
			console.log("pushed... " + userdb[i].name);
		}
	}
