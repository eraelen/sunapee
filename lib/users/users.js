...
var userdb = [
{name: 'Tim Berners-Lee' ,username: 'tim', password: 'mit', uid: 1, email: "aqua_manga@yahoo.com", location: "Massachusetts", website: "amazon.com", profilePic: "/images/defaultProfilePic.jpg", follower: ["caleb","hazel"], following: ["caleb"], tweets: [0,4], profVis: "Public", mentionPerm: "Public", pmPerm: "Public", pmUsers:[]},
{name: 'Hazel Rozetta', username: 'hazel', password: 'lezah', uid: 2, email: "ysasaki@smith.edu", location: "United States", website: "petco.com", profilePic: "/images/defaultProfilePic.jpg", follower: ["caleb"], following: ["tim", "caleb"], tweets: [1,5], profVis: "Public", mentionPerm: "Public", pmPerm: "Public", pmUsers: []},
{name: 'Caleb Marks', username: 'caleb', password: 'belac', uid: 3, email: "ysasaki2014@gmail.com", location: "Asia", website: "ebay.com", profilePic: "/images/defaultProfilePic.jpg", follower: ["hazel","tim"], following: ["hazel","tim"], tweets: [2,3], profVis: "Public", mentionPerm: "Public", pmPerm: "Public", pmUsers: []},
{name: 'Eeyore', username: 'cheerfuldonkey', password: 'eeyore', uid: 4, email: "mynameiseeyore@hundredacrewood.com", location: "Hundred Acre Wood", website: "", profilePic: "/images/users/cheerfuldonkey/eeyore_profilepic.jpg", follower: [], following: [], tweets: [], profVis: "Public", mentionPerm: "Public", pmPerm: "Public", pmUsers: []},
{name: 'Winnie', username: 'thepooh', password: 'winnie', uid: 5, email: "mynameiswinnie@hundredacrewood.com", location: "Hundred Acre Wood", website: "", profilePic: "/images/users/thepooh/pooh_profilepic.jpg", follower: [], following: [], tweets: [], profVis: "Public", mentionPerm: "Public", pmPerm: "Public", pmUsers: []}
];
...
function changeUserProfile(username, nname, nusername, nemail, nlocation, nwebsite, nnewpass, nconfirmnewpass, ncurrentpass, req, user) {
	...
	if (ncurrentpass === userdb[user.uid-1].password) {
		...
		if (nname !== '') { userdb[user.uid-1].name = nname; }
		if (nusername !== '') { userdb[user.uid-1].username = nusername; req.session.user = user;}
